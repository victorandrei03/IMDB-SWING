...
public class Regular<T extends Comparable<T>> extends User<T> implements RequestsManager {
    ...
    public Regular(){}
    public Regular(Information info, int experience, SortedSet<T> favorites, String username,
                   List<String> notifications) {
        super(info, AccountType.Regular, experience, favorites, username, notifications);
    }
    ...
    public void createRequest(int operation) {
        ...
        if (user_found != null) {
            if (operation == 1) {
                ...
                r.notifyObservers("A request has been created and added to the" +
